...
export default function ProfileInfoGrid({ profile }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <InfoCard icon={Phone} label="Phone" value={profile.phone_number} />
      <InfoCard icon={Calendar} label="Birth Date" value={birthDateLabel} />
      <InfoCard icon={UserRound} label="Gender" value={profile.gender} />
